...
% Save the figure
saveas(gcf, fullfile(folderName, 'spatial_mat_combined.jpg'), 'jpg');
...
% Save the figure
formatFileName = "spatial_ls_subplot.jpg";
fileName = sprintf(formatFileName);
fullFilePath = fullfile(folderName, fileName);
saveas(gcf, fullFilePath, 'jpg');
...
plot(DO_range, DD_meteoric, 'k--', 'DisplayName', 'GMWL', 'LineWidth', 0.5);
hold on;
plot(mKnikMain(:,9), mKnikMain(:,10), 'ko', 'DisplayName', 'Knik','MarkerFaceColor', [0.35,0.70,0.90],'MarkerSize', ms, 'LineWidth', 0.5);
plot(mMatMain(:,9), mMatMain(:,10), 'ko', 'DisplayName', 'Matanuska','MarkerFaceColor', [0.95,0.90,0.25],'MarkerSize', ms, 'LineWidth', 0.5);
plot(mMCData(:,9), mMCData(:,10), 'ko', 'DisplayName', 'Moose Creek','MarkerFaceColor', [0.90,0.60,0],'MarkerSize', ms, 'LineWidth', 0.5);
plot(mLSMain(:,9), mLSMain(:,10),'ko', 'DisplayName', 'Little Susitna','MarkerFaceColor', [0,0.60,0.50],'MarkerSize', ms, 'LineWidth', 0.5);
plot(mGulkanaMain(:,9), mGulkanaMain(:,10), 'ko', 'DisplayName', 'Gulkana','MarkerFaceColor', [0.80,0.40,0],'MarkerSize', ms, 'LineWidth', 0.5);plot(mGulkanaSupra(:,9), mGulkanaSupra(:,10), 'kv', 'DisplayName', 'Gulkana Supraglacial','MarkerFaceColor', [0.80,0.40,0],'MarkerSize', ms, 'LineWidth', 0.5);
plot(mCastnerMain(:,9), mCastnerMain(:,10),'ko', 'DisplayName', 'Castner','MarkerFaceColor', [0,0.45,0.70],'MarkerSize', ms, 'LineWidth', 0.5);
plot(mCanwellData(:,9), mCanwellData(:,10), 'ko', 'DisplayName', 'Canwell','MarkerFaceColor', [0.80,0.60,0.70],'MarkerSize', ms, 'LineWidth', 0.5);
...
folderName = 'U:/GoA plots/NewPlots';
fileName = 'isotope_comparison_watershed_main.svg';
fullFilePath = fullfile(folderName, fileName);
saveas(gcf, fullFilePath, 'svg');
